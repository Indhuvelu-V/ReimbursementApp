...
export class CreateUserResponseDto { userId: string = ''; userName: string = ''; email: string = ''; role: UserRole = UserRole.Employee;
     department: DepartmentType = DepartmentType.IT;
     status: UserStatus = UserStatus.Active; approvalLevel?: ApprovalLevel; }
